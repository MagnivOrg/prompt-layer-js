...
export class PromptLayer {
    ...
    constructor({
        ...
        this.tracer = trace.getTracer('promptlayer-tracer');
    }
    ...
    async run({
        ...
        return this.tracer.startActiveSpan('PromptLayer.run', async (span: any) => {
            try {
                ...
                if (stream) {
                    span.setAttributes({
                        'promptlayer.prompt_name': promptName,
                        'promptlayer.prompt_version': promptVersion,
                        'promptlayer.group_id': groupId,
                        'promptlayer.stream': true,
                    });
                ...
                span.setAttributes({
                    ...
                    'promptlayer.prompt_version': promptVersion,
                    'promptlayer.group_id': groupId,
                    'promptlayer.request_id': data.request_id,
                });
